...
const steps = [
  {
    ...
    desc: "Kami diskusi kebutuhan, tujuan bisnis, dan target audiens Anda untuk menentukan strategi website yang tepat.",
    icon: (
  ...
  },
  {
    ...
    desc: "Tim kami membuat desain UI/UX yang modern, mobile-friendly, dan sesuai dengan identitas brand Anda.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    number: "03",
    title: "Pengembangan",
    desc: "Website dikembangkan dengan teknologi terkini — cepat, aman, dan SEO-friendly sejak hari pertama.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    number: "04",
    title: "Launch & Deploy",
    desc: "Website siap online! Kami bantu setup domain, hosting, dan pastikan semuanya berjalan mulus.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "Kami tidak berhenti setelah launch. Dukungan penuh untuk update, perbaikan, dan pengembangan lanjutan.",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="relative container mx-auto px-6">
        <div className="text-center mb-16 reveal">
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            Proses sederhana dan transparan dari konsultasi hingga website siap digunakan
          </p>
        </div>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-4">
            {steps.map((step, index) => (
              <div key={index} className="reveal group relative flex flex-col items-center text-center">
                {/* Step circle */}
                <div className="relative mb-6">
                  ...
                  <div className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-[#0f172a] border border-[#22c55e]/30 flex items-center justify-center">
                    <span className="text-[10px] font-bold text-[#22c55e]">{step.number}</span>
                  </div>
                </div>
