...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#a78bfa]/5 rounded-full blur-[200px] animate-pulse pointer-events-none" style={{ animationDelay: "3s" }} />
      ...
      <div className="relative z-10 container mx-auto px-6 pt-24 pb-16">
        <div className="max-w-5xl mx-auto text-center">
          {/* Badge */}
          <div className="reveal inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#a78bfa]/30 bg-[#a78bfa]/10 text-[#c084fc] text-sm font-medium mb-8 backdrop-blur-sm">
          ...
          <div className="reveal reveal-delay-3 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="group relative inline-flex items-center gap-2.5 px-8 py-4 bg-[#a78bfa] text-white font-bold rounded-xl text-lg transition-all duration-300 hover:bg-[#7c3aed] hover:scale-105 animate-pulse-glow"
            >
          ...
          <div className="reveal reveal-delay-4 mt-20 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {[
              ...
              <div
                key={i}
                className="group relative p-5 rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-[#a78bfa]/30 transition-all duration-500 hover:bg-white/[0.06]"
              >
                <div className="text-3xl md:text-4xl font-extrabold text-[#a78bfa] mb-1">
                  {stat.value}
                </div>
