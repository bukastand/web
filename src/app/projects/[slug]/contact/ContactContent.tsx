  ...
  return (
    <>
      ...
      <section className="relative min-h-[60vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white leading-tight mb-6">
            <span className="gradient-text">Kontak</span> Kami
          </h1>
      ...
      <section className="relative py-24 bg-[#0f172a]">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-[#22c55e]/5 rounded-full blur-[120px] pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div className="space-y-8 reveal-section opacity-0 translate-y-8 transition-all duration-700">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-1">Alamat</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-1">Telepon</h4>
                  <a href={`tel:${contactSection.phone}`} className="text-white hover:text-[#22c55e] transition-colors">{contactSection.phone}</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${contactSection.email}`} className="text-white hover:text-[#22c55e] transition-colors">{contactSection.email}</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-1">Jam Operasional</h4>
                  <p className="text-white">{contactSection.hours}</p>
                </div>
              </div>

              {/* Map placeholder */}
              <div className="h-48 rounded-2xl bg-white/5 border border-white/10 overflow-hidden flex items-center justify-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-5 py-3.5 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-600 focus:outline-none focus:border-[#22c55e]/50 focus:ring-1 focus:ring-[#22c55e]/20 transition-all"
                ...
                <div>
                  <label className="block text-sm text-gray-400 mb-2">No. Telepon</label>
                  <input
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-5 py-3.5 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-600 focus:outline-none focus:border-[#22c55e]/50 focus:ring-1 focus:ring-[#22c55e]/20 transition-all resize-none"
                    placeholder="Tulis pesan Anda..."
                  />
                </div>
                <button
                  type="submit"
                  className="w-full py-4 bg-[#22c55e] text-white font-bold rounded-xl text-lg hover:bg-[#16a34a] transition-all duration-300 hover:shadow-xl hover:shadow-[#22c55e]/25"
                >
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="reveal-section max-w-2xl mx-auto opacity-0 translate-y-8 transition-all duration-700">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              Lebih Cepat <span className="gradient-text">Melalui WhatsApp</span>
            </h2>
