...
const categories = ["Semua", "Website Sekolah", "Website Property", "Toko Online", "Klinik & RS", "Website Travel", "Website Hotel", "Portal Berita", "Company Profile"];
    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-lg sm:text-xl text-[#666666] max-w-3xl mx-auto leading-relaxed mb-12">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                  activeCategory === cat
                    ...
                    : "bg-white text-[#666666] border border-[#eeeeee] hover:bg-[#eeeeee] hover:text-[#111111]"
                }`}
              >
                {cat}
              </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredProjects.length > 0 ? (
              filteredProjects.map((project, index) => (
                ...
                >
                  <div className={`relative h-48 bg-gradient-to-br ${project.gradient} flex items-center justify-center overflow-hidden`}>
                    ...
                    <span className="absolute top-3 left-3 px-3 py-1 bg-white/80 text-[#666666] text-xs font-medium rounded-full border border-white">
                      {project.category}
                    </span>
                    <div className="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <span className="text-[#111111] text-sm font-semibold px-4 py-2 bg-white/90 rounded-lg">
                        Lihat Detail
                      </span>
                    </div>
              ...
              <div className="col-span-full text-center py-16">
                <p className="text-[#999999]">Belum ada project di kategori ini</p>
              </div>
            )}
          </div>
