...
export default function ArticlePage() {
  ...
  // Set current URL only on client-side to avoid SSR window reference error
  useEffect(() => {
    ...
    return (
      <main className="min-h-screen bg-[#0f172a] flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-500 mb-6">Artikel yang kamu cari tidak tersedia atau belum dipublikasikan.</p>
          <Link
            href="/blog"
  ...
  return (
    <main className="min-h-screen bg-[#0f172a]">
      {/* Navbar placeholder (same as public layout) */}
      ...
      <article className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
        ...
        {/* Cover Image */}
        {article.cover_image && (
          <div className="aspect-[21/9] rounded-2xl overflow-hidden mb-8 border border-white/10">
            <img
        ...
        {/* Excerpt */}
        {article.excerpt && (
          <p className="text-lg text-gray-400 mb-8 leading-relaxed border-l-4 border-[#22c55e]/50 pl-4">
            {article.excerpt}
          </p>
        )}

        {/* Divider */}
        <div className="h-px bg-gradient-to-r from-[#22c55e]/50 via-white/10 to-transparent mb-8" />

        {/* Content - Rendered HTML */}
        {article.content ? (
          <div
            className="prose prose-invert prose-lg max-w-none prose-headings:text-white prose-a:text-[#22c55e] prose-a:no-underline hover:prose-a:underline prose-img:rounded-xl prose-img:border prose-img:border-white/10 prose-blockquote:border-[#22c55e] prose-blockquote:text-gray-300 prose-strong:text-white prose-code:text-[#22c55e] prose-pre:bg-white/5 prose-pre:border prose-pre:border-white/10"
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            {[
              {
                label: "WhatsApp",
                url: `https://wa.me/?text=${encodeURIComponent(`${article.title} - ${currentUrl}`)}`,
              },
              {
                label: "Facebook",
      ...
      {relatedArticles.length > 0 && (
        <section className="max-w-6xl mx-auto px-4 pb-16">
          ...
          <h2 className="text-2xl font-bold text-white mb-8 text-center">
            Artikel <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#22c55e] to-[#4ade80]">Terkait</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {relatedArticles.map((related) => (
              <Link
                ...
                className="group bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-[#22c55e]/30 transition-all duration-300"
              >
                {related.cover_image ? (
                  ...
                  <div className="aspect-[16/9] bg-[#0a0f1e] flex items-center justify-center">
                ...
                <div className="p-4">
                  ...
                  <h3 className="text-white font-semibold line-clamp-2 group-hover:text-[#22c55e] transition-colors">
                    {related.title}
                  </h3>
                </div>
              </Link>
